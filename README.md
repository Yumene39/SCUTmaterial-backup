...
## This is a backup repo of the original ```SCUTmaterial```. Only for download and will not accept any pull request. Please use it  cautiously.

## Wish you for a good grade.

## 这是原始```SCUTmaterial```仓库的备份版本。资料继续提供下载使用，但不再接受任何Pull Request。请谨慎使用，自求多福。
